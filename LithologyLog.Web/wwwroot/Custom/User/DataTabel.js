        ...
        "columns": [
            {
                data: null, render: function (row) {
                    return `<ul class="d-flex justify-content-center">
                               <li class="mr-2">
                                <a href="/User/Edit?id=${row.Id}" data-toggle="modal" id="editButton"  data-target="#pageModal" class=" btn text-primary btn-sm "><i class='fa fa-edit'></i></a>
                               </li>
                               <li class="mr-2">
                                <a href="/User/Delete?id=${row.Id}"   id="deleteButton" class=" btn text-primary btn-sm "><i class='fa fa-trash'></i></a>
                               </li>
                            </ul>`;
                }
            },
